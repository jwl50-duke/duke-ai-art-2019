...
#change tick_kimg_dict to be the number of iterations per tick, might be good for timing
def training_schedule(
    ...
    tick_kimg_dict          = {4: 160, 8:140, 16:120, 32:100, 64:80, 128:60, 256:30, 512:20, 1024:20}): # Resolution-specific overrides.
...
def training_loop(
    ...
    resume_run_id           = os.path.join('./results/stillduck.pkl'),     # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = None,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 7000,      # Assumed training progress at the beginning. Affects reporting and training schedule. we set to 7k so it starts at larger resolution
